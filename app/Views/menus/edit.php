    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <?= form_open('/daftar-menu/update'); ?>

                <div class="card-body">

                    <input type="hidden" name="id" id="id" value="<?= $menu['id']; ?>">
                    <input type="hidden" name="slugLama" id="slugLama" value="<?= $menu['slug']; ?>">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= (validation_show_error('nama')) ? 'is-invalid' : ''; ?>" id="nama" name="nama" value="<?= (old('nama')) ? old('nama') : $menu['nama']; ?>" autofocus>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select name="parent" id="parent" class="form-select <?= (validation_show_error('parent')) ? 'is-invalid' : ''; ?>">
                                    ...
                                    <option value="0" <?= (old('parent') === "0" || $menu['parent_id'] === "0") ? 'selected' : ''; ?>>Tidak ada parent</option>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= (validation_show_error('url')) ? 'is-invalid' : ''; ?>" id="url" name="url" value="<?= (old('url')) ? old('url') : $menu['url']; ?>">
                                <small>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= (validation_show_error('icon')) ? 'is-invalid' : ''; ?>" id="icon" name="icon" value="<?= (old('icon')) ? old('icon') : $menu['icon']; ?>">
                                <small>
